...
For more information about the overall dataset structure and access methods, please refer to the main [README](../../google-cloud-mlb-hackathon/README.md) in the root directory. 