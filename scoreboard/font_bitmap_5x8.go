...
// 5x8 bitmap font metrics.
const (
	fontW5x8    = 5 // glyph pixel width
	fontH5x8    = 8 // glyph pixel height
	fontAdv5x8  = 6 // advance per character (fontW + 1px gap)
	fontRowH5x8 = 9 // row advance (fontH + 1px gap)
)

// font5x8 stores glyph rows as 5-bit bitmaps.
var font5x8 = map[rune][8]byte{
	' ': {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
	'-': {0x00, 0x00, 0x00, 0x1F, 0x00, 0x00, 0x00, 0x00},
	'.': {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x00},
	'/': {0x01, 0x02, 0x02, 0x04, 0x08, 0x08, 0x10, 0x00},
	'0': {0x0E, 0x11, 0x13, 0x15, 0x19, 0x11, 0x0E, 0x00},
	'1': {0x04, 0x0C, 0x04, 0x04, 0x04, 0x04, 0x1F, 0x00},
	...
	'J': {0x1F, 0x02, 0x02, 0x02, 0x12, 0x12, 0x0C, 0x00},
